...
- 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝒎𝒂x 🇪🇬 @Turbo_ismax .
",'parse_mode' => "MarkDown", 'disable_web_page_preview' => true,
'reply_markup' => json_encode(['inline_keyboard' => [
[['text' => "-𝒎𝒂x'", 'url' => "https://t.me/Y_Y_a"]],
...
bot('sendvideo', ['video' =>'https://t.me/vd_d_dd/29', 'chat_id' => file_get_contents("ID"), 'caption' => "• ➞ 𝐇𝐈 \n• ➞ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝐈𝐍 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌\n• ➞ 𝐁𝐲 : 𝐌𝐀𝐗",
'parse_mode' => "MarkDown", 
...
if ($text == "⌞𝐏𝐢𝐧𝐠⌝") {
	...
	$ping = shell_exec("ping -c 1 167.99.32.43 | grep -oP 'time=\K[^ ]+'");
...
if($text == "⌞𝐔𝐩𝐝𝐚𝐭𝐞 ~ 𝐅𝐢𝐥𝐞𝐬 ~ 𝐂𝐡𝐞𝐜𝐤𝐞𝐫⌝"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/1.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/6.php");
	file_put_contents("7.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/8.php");
...
if($text == "⌞𝐔𝐩𝐝𝐚𝐭𝐞 ~ 𝐌𝐚𝐝𝐞𝐥𝐢𝐧𝐞⌝"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/madeline.php");
...
if($text == "⌞𝐔𝐩𝐝𝐚𝐭𝐞 ~ 𝐘𝐨𝐮𝐫 ~ 𝐁𝐨𝐭⌝"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Bot-delete-/blob/main/bot.php");
